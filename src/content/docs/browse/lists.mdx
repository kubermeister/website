...
<Figure
  ...
  caption="Rows update from a watch, and only the rows in view are rendered."
/>
...
<Figure
  ...
  caption="Grouping interleaves heading rows into the virtualised list rather than nesting tables."
/>
