...
<Figure
  ...
  alt="The manifest editor showing an object as YAML with the change about to be applied."
  caption="A replace carries the resourceVersion it was read with, so a concurrent change becomes a conflict."
/>
