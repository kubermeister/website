...
<Figure
  ...
  caption="Events for one object come from the same reader as the cluster-wide stream."
/>
...
<Figure
  ...
  caption="Describe is a structured document, so the copy and download buttons render the same content to text."
/>
...
<Figure
  ...
  caption="Every relation says why: mounted as volume, envFrom, selects these pods, runs as."
/>
